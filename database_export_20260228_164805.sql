...
--
-- Host: localhost    Database: ibunbaz_drais
-- ------------------------------------------------------
...
CREATE TABLE `attendance_audit_logs` (
  ...
  `school_id` bigint NOT NULL,
  `entity_type` enum('daily_attendance','manual_entry','device','rule') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `entity_id` bigint NOT NULL,
  `change_type` enum('create','update','delete','process') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `attendance_logs` (
  ...
  `verification_status` enum('success','failed','unknown') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'success',
  `biometric_quality` int DEFAULT NULL,
  `device_log_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `device_sync_count` int DEFAULT '1',
  `processing_status` enum('pending','processed','error','duplicate') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `process_error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `attendance_processing_queue` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `school_id` bigint NOT NULL,
  `job_type` enum('process_device_logs','calculate_daily_attendance','recalculate_date_range','rule_recalculation','sync_device') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `parameters` json DEFAULT NULL,
  `status` enum('queued','processing','completed','failed','retrying') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'queued',
...
CREATE TABLE `attendance_reconciliation` (
  ...
  `manual_status` enum('present','absent','late','excused') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `manual_marked_by` bigint DEFAULT NULL,
  `manual_marked_at` timestamp NULL DEFAULT NULL,
  `biometric_status` enum('present','absent','late') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `biometric_marked_at` timestamp NULL DEFAULT NULL,
  `reconciliation_status` enum('matched','conflict','biometric_only','manual_only') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'matched',
  `conflict_resolution` enum('trust_biometric','trust_manual','manual_correction') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'trust_biometric',
...
CREATE TABLE `attendance_reports` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `school_id` bigint NOT NULL DEFAULT '1',
  `report_type` enum('daily_summary','weekly_trend','monthly_summary','class_analysis','student_profile','period_comparison') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'daily_summary',
...
CREATE TABLE `attendance_rules` (
  ...
  `applies_to` enum('students','teachers','all') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'students',
  `applies_to_classes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `attendance_sessions` (
  ...
  `session_type` enum('morning_check','lesson','assembly','afternoon_check','custom') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'lesson',
  `attendance_type` enum('manual','biometric','hybrid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'manual',
  `status` enum('draft','open','submitted','locked','finalized') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'draft',
...
CREATE TABLE `attendance_users` (
  ...
  `role` enum('admin','director','teacher','parent','student','staff') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'staff',
  `is_active` tinyint(1) DEFAULT '1',
...
CREATE TABLE `biometric_devices` (
  ...
  `device_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `device_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'fingerprint',
  ...
  `status` enum('active','inactive','maintenance','offline') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `last_sync_at` timestamp NULL DEFAULT NULL,
  `sync_status` enum('synced','pending','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `sync_error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `dahua_attendance_logs` (
  ...
  `event_type` enum('Entry','Exit','Unknown') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Entry',
  `method` enum('fingerprint','card','face','password','unknown') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'unknown',
  `status` enum('present','absent','late','processed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'processed',
...
CREATE TABLE `dahua_devices` (
  ...
  `device_type` enum('attendance','access_control','hybrid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'attendance',
  `protocol` enum('http','https') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'http',
  `status` enum('active','inactive','offline','error') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `last_sync` timestamp NULL DEFAULT NULL,
  `last_sync_status` enum('success','failed','pending') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
CREATE TABLE `dahua_raw_logs` (
  ...
  `parse_errors` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_device` (`device_id`),
  KEY `idx_created` (`created_at`)
...
CREATE TABLE `dahua_sync_history` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `device_id` bigint NOT NULL,
  `sync_type` enum('manual','scheduled','automatic') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'manual',
  `records_fetched` int DEFAULT '0',
  `records_processed` int DEFAULT '0',
  `records_failed` int DEFAULT '0',
  `status` enum('in_progress','success','failed','partial') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'in_progress',
...
CREATE TABLE `daily_attendance` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `school_id` bigint NOT NULL,
  `person_type` enum('student','teacher') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `person_id` bigint NOT NULL,
  `attendance_date` date NOT NULL,
  `status` enum('present','late','absent','excused','on_leave','pending') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  ...
  `excuse_type` enum('medical','parental','official','other','none') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'none',
  `excuse_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `device_sync_checkpoints` (
  ...
  `sync_status` enum('success','partial','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'success',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `device_sync_logs` (
  ...
  `school_id` bigint NOT NULL DEFAULT '1',
  `device_id` bigint NOT NULL,
  `sync_type` enum('attendance_download','fingerprint_upload','logs_fetch','device_sync') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'attendance_download',
  `sync_direction` enum('pull','push','bidirectional') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pull',
  `status` enum('pending','in_progress','success','partial_success','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `records_processed` int DEFAULT '0',
...
INSERT INTO `enrollments` VALUES (681,662,NULL,NULL,NULL,NULL,NULL,'active','2026-02-28 09:44:33');
...
CREATE TABLE `manual_attendance_entries` (
  ...
  `person_id` bigint NOT NULL,
  `attendance_date` date NOT NULL,
  `status` enum('present','late','absent','excused','on_leave') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `arrival_time` time DEFAULT NULL,
  `departure_time` time DEFAULT NULL,
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `override_type` enum('status_change','new_entry','excuse_update','time_correction') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'status_change',
...
INSERT INTO `people` VALUES (681,1,'NALUBANGA','MARIAM',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2026-02-28 09:44:33',NULL,NULL);
...
CREATE TABLE `student_fingerprints` (
  ...
  `finger_position` enum('thumb','index','middle','ring','pinky','unknown') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'unknown',
  `hand` enum('left','right') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'right',
  `template_data` longblob,
  `template_format` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `biometric_uuid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quality_score` int DEFAULT '0',
  `enrollment_timestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `is_active` tinyint(1) DEFAULT '1',
  `status` enum('active','inactive','revoked') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active',
...
INSERT INTO `students` VALUES (662,1,681,NULL,NULL,'XHN/0681/2026',NULL,NULL,'active','pending',NULL,NULL,NULL,NULL,'2026-02-28 09:44:33',NULL,NULL);
...
--
-- Dumping data for table `tahfiz_records`
--

LOCK TABLES `tahfiz_records` WRITE;
/*!40000 ALTER TABLE `tahfiz_records` DISABLE KEYS */;
/*!40000 ALTER TABLE `tahfiz_records` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-02-28 16:48:06
