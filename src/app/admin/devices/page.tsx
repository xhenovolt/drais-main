...
import { Activity, Wifi, WifiOff, Server, Clock, MapPin, Hash } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Real-time ZKTeco ADMS heartbeat tracking &bull; Auto-refreshes every 30s
              </p>
            </div>
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {device.model_name && (
                <p className="text-xs text-gray-500 dark:text-gray-400">{device.model_name}</p>
              )}
            </div>
          </div>
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
            ...
            <span className="text-xs">ID #{device.id}</span>
          </div>
        </div>
      </div>
    </div>
