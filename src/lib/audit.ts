...
export const AuditAction = {
  ...
  PURGED_STUDENT:           'PURGED_STUDENT',
  RESIDENCY_STATUS_CHANGED: 'RESIDENCY_STATUS_CHANGED',
  BOARDING_PRESENCE_CHANGED: 'BOARDING_PRESENCE_CHANGED',
  // Results
  CREATED_RESULT:           'CREATED_RESULT',
  UPDATED_RESULTS:          'UPDATED_RESULTS',
  APPROVED_RESULTS:         'APPROVED_RESULTS',
  EXPORTED_RESULTS:         'EXPORTED_RESULTS',
  // Data exports + report generation (P2/P3 accountability — "who exported what")
  EXPORTED_ATTENDANCE:      'EXPORTED_ATTENDANCE',
  EXPORTED_STUDENTS:        'EXPORTED_STUDENTS',
  ...
  // System / operational (P2)
  SMS_SENT:                 'SMS_SENT',
  SETTINGS_CHANGED:         'SETTINGS_CHANGED',
  COMMENT_RULE_CHANGED:     'COMMENT_RULE_CHANGED',
