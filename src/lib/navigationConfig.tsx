  ...
  return [
    ...
    // Attendance-first architecture: biometrics, devices, monitoring
    {
      ...
      children: [
        ...
        { key: 'att-intelligence',   label: 'Intelligence',      icon: <Fingerprint className="w-4 h-4" />,  href: '/attendance/intelligence' },
        ...
        { key: 'device-observability', label: 'Raw Pipeline',    icon: <Activity className="w-4 h-4" />,     href: '/attendance/device-logs' },
    ...
    // ══ 9. SETTINGS ═══════════════════════════════════════════════════════════
    {
      ...
      children: [
        { key: 'school-settings', label: 'School Info',    icon: <School className="w-4 h-4" />,   href: '/settings' },
        { key: 'theme-settings',  label: 'Theme',          icon: <Palette className="w-4 h-4" />,  href: '/settings/theme' },
        { key: 'system-settings', label: 'System',         icon: <Cog className="w-4 h-4" />,      href: '/settings/system' },
