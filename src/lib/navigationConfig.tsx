...
const LABEL_AR: Record<string, string> = {
  ...
  'Visitation Cards':          'بطاقات الزيارة',
  'Pass-out Reports':          'تقارير أذونات الخروج',
  ...
  'Help & Guides':             'المساعدة والأدلة',
  'Help Center':               'مركز المساعدة',
  'Your first week':           'أسبوعك الأول',
  'Learners day to day':       'المتعلمون يوميًا',
  'Enrolling fingerprints':    'تسجيل البصمات',
  'Attendance day to day':     'الحضور يوميًا',
  'Marks & report cards':      'الدرجات وبطاقات التقارير',
  'Fees & payments':           'الرسوم والمدفوعات',
  'Messaging guardians':       'مراسلة أولياء الأمور',
  ...
  const items: MenuItem[] = [
    ...
    // ══ 6. FINANCE ════════════════════════════════════════════════════════════
    {
      ...
      children: [
        ...
        // Sits between the rules that define fees and the bills generated from
        // them, because that is the order the work happens in: define, publish
        // the circular, then bill.
        { key: 'fee-circular',       label: 'Fee Circular',      icon: <FileText className="w-4 h-4" />,     href: '/finance/circular' },
